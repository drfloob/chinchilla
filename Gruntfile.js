...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            options: {
                ...
                mangle: {},
                compress: {},
                sourceMap: 'dist/chinchilla.min.js.map',
                preserveComments: 'some'
            },
            build: {
                src: 'src/chinchilla.js',
                dest: 'dist/chinchilla.min.js'
            }
        },
        compare_size: {
            files: ['src/chinchilla.js', 'dist/chinchilla.min.js']
        },
        jshint: {
    ...
    grunt.registerTask('test', ['copy:vendor', 'jasmine_node']);
